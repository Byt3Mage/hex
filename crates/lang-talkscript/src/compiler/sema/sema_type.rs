...
use crate::{
    ...
    compiler::{ast::DeclId, sema::sema_value::ComptimeInt},
};

define_id!(SemaTypeId);
...
pub enum SemaType {
    ...
    // Compound
    Opt(SemaTypeId),
    Ptr { mutable: bool, pointee: SemaTypeId },
    Array { elem: SemaTypeId, len: u64 },
    Slice(SemaTypeId),
    ...
    // Functions
    Function(Rc<[SemaTypeId]>, SemaTypeId),
